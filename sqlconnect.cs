...
namespace CW_EZ_Renewals
{
    public class sqlconnect
    {
        ...
        private string connectionString = "Provider=MSOLEDBSQL;Persist Security Info=False;Data Source=10.56.0.42;Initial Catalog=NewOrleansLA;User ID=cwNOLA;Password=Password1!";
